...
namespace MissionSharedLibrary.View.ViewModelCollection.HotKey
{
    public class MissionLibraryGameKeyOptionCategoryVM : ViewModel
    {
        ...
        public MissionLibraryGameKeyOptionCategoryVM(AGameKeyCategoryManager gameKeyCategoryManager, Action<IHotKeySetter> onKeyBindRequest)
        {
            ...
            {
                var vm = CreateAHotKeyConfigVM(category.Value, onKeyBindRequest);
        ...
        private AHotKeyConfigVM CreateAHotKeyConfigVM(AGameKeyCategory gameKeyCategory, Action<IHotKeySetter> onKeyBindRequest) 
        {
            if (gameKeyCategory is GameKeyCategory) 
            {
                return new MissionLibraryGameKeySequenceGroupVM(gameKeyCategory.GameKeyCategoryId, gameKeyCategory.GameKeySequences, onKeyBindRequest, null);
            }
        ...
        public void ExecuteResetToDefault()
        {
            InformationManager.ShowInquiry(
                new InquiryData(
                    ...
                    new TextObject("{=YjbNtFcw}This will reset ALL keys to their default states. You won't be able to undo this action. {newline} {newline}Are you sure?").ToString(), 
                    true, 
                    true,
