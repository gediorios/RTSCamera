    ...
    public class RTSCameraOptionClassFactory
    {
        public static IObjectIdentitfication<AOptionClass> CreateOptionClassProvider(IMenuClassCollection menuClassCollection)
        {
            ...
            return ObjectIdentitfication<AOptionClass>.Create(() =>
            {
                ...
                if (!RTSEngineState.WatchMode)
                {
                    cameraOptionCategory.AddOption(new SelectionOptionViewModel(
                        ...
                        new SelectionOptionData(i =>
                        {
                            ...
                            {
                                Utility.UpdateMainAgentControllerInFreeCamera(Mission.Current.MainAgent,(Agent.ControllerType) i);
                                Utility.UpdateMainAgentControllerState(Mission.Current.MainAgent, rtsCameraLogic.SwitchFreeCameraLogic.IsSpectatorCamera, (Agent.ControllerType) i);
                            }
                        }, 
                        () =>
                        {
                ...
                var controlOptionCategory = new OptionCategory("Control", GameTexts.FindText("str_rts_camera_control_options"));

                var playerFormationOption = new SelectionOptionViewModel(
                    GameTexts.FindText("str_rts_camera_player_formation"),
                    GameTexts.FindText("str_rts_camera_player_formation_hint"), 
                ...
                var miscellaneousOptionCategory = new OptionCategory("Miscellaneous", GameTexts.FindText("str_rts_camera_miscellaneous_options"));
                ...
                {
                    var cheatOptionCategory = new OptionCategory("Cheat", GameTexts.FindText("str_rts_camera_unbalanced_options_description"));
