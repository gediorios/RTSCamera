...
namespace RTSCamera.Patch.Fix
{
    ...
    {
        private static readonly Harmony Harmony = new Harmony(Constants.ModuleId + "_" + nameof(Patch_MissionOrderGauntletUIHandler));
        ...
        private static void RegisterReload(MissionOrderGauntletUIHandler uiHandler)
        {
            ...
            MissionEvents.PreSwitchTeam += OnPreSwitchTeam;
        ...
        private static void OnPostSwitchTeam()
        {
            ...
            InitializeInADisgustingManner?.Invoke(Mission.Current.GetMissionBehaviour<OrderTroopPlacer>(), new object[] { });
            _isInSwitchTeamEvent = false;
        }
    }
}
