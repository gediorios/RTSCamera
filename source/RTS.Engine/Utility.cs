...
namespace MissionSharedLibrary.Utilities
{
    public static class Utility
    {
        ...
        {
            return
                agent.Formation != null && agent.Formation.GetReadonlyMovementOrderReference().OrderType == OrderType.ChargeWithTarget && RTSCameraConfig.Get().AttackSpecificFormation &&
