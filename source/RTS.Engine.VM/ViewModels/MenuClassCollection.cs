...
namespace MissionSharedLibrary.View
{
    ...
    {
        private readonly List<IObjectIdentitfication<AOptionClass>> _optionClasses = new List<IObjectIdentitfication<AOptionClass>>();
        private MenuClassCollectionViewModel _viewModel;
        private string _previouslySelectedOptionClassId = "";

        public void AddOptionClass(IObjectIdentitfication<AOptionClass> provider)
        {
        ...
        {
            if(_viewModel == null)
                _viewModel = new MenuClassCollectionViewModel(_optionClasses, _previouslySelectedOptionClassId);
    ...
    public class MenuClassCollectionViewModel : ViewModel
    {
        ...
        public MenuClassCollectionViewModel(List<IObjectIdentitfication<AOptionClass>> optionClasses, string selectedOptionClassId)
        {
